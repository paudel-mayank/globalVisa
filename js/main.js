...
class D {
  ...
  destroy(e, t) {
    ...
    return typeof s.params > "u" || s.destroyed
  ...
  function p() {
    ...
    typeof d.el == "string" && e.isElement && (m = e.el.querySelector(d.el)),
      ...
      && (e.params.uniqueNavElements && typeof d.el == "string" && Array.isArray(m) && m.length > 1
        && (m = [...e.el.querySelectorAll(d.el)], m.length > 1 && (m = m.filter(v => _e(v, ".swiper")[0] === e.el)[0])),
...
new Swiper(".team-swiper", {
  ...
  autoplay: { delay: 200, disableOnInteraction: false },
  // slidesPerView: 6,
  breakpoints: { 1024: { slidesPerView: 3 }, 640: { slidesPerView: 1 }, 0: { slidesPerView: 1 } },
  // pagination: { el: ".swiper-pagination", clickable: false },
});
...
function equalizeHeights() {
  ...
  if (window.innerWidth >= 1024) {
    ...
    imageColumn.style.minHeight = maxHeight + "px";
  }
}
