...
h-full bg-cover bg-center bg-no-repeat" style="background-image: url('assets/allBackground-8d35f342.png');">
  ...
  <div class="container  pt-[140px] sm:pt-[170px] lg:pt-[190px] xl:pt-[223px] pb-[110px] sm:pb-[130px]">
    ...
    <div data-aos="fade-right" data-aos-delay="500"
      ...
      <div
        ...
        <a href="testimonials.php" class="sm:text-subtitle2 font-medium sm:font-subtitle2 hover:text-primary-light
                         transition-all duration-300 ease-linear">About</a>
        <img class="hidden" src="assets/miniLine-a36e5f89.svg" alt="miniLines" />
        <a href="testimonials.php" class="hidden sm:text-subtitle2 font-medium sm:font-subtitle2
                         hover:text-primary-light transition-all duration-300 ease-linear"></a>
      </div>
    </div>
  </div>
</div>

<div class="flex flex-col overflow-x-hidden  gap-[70px] xl:gap-[100px] pt-[70px] xl:pt-[100px]">
  <div class="relative w-full h-full">
    <div class="flex-equal-height gap-10 mb-20 items-center container">
      <div class=" text-section max-w-[680px] mx-auto lg:text-start
       text-center pt-1 xl:pt-0" id="text-column">
      ...
      <div data-aos="fade-left" class="image-section">
...
<div class="relative overflow-hidden w-full h-full  py-[70px] xl:py-[100px]">

  <div class="flex-equal-height gap-10 items-center container xl:gap-[100px]">
    <div class="image-section">
      <img src="assets/mission.jpg" class="w-full" alt />
    </div>

    <div data-aos="text-section fade-left ">
  ...
  <div class="relative overflow-x-hidden w-full h-full  gap-[70px] xl:gap-[100px] py-[70px] xl:py-[100px] mt-20">


    <div class=" flex flex-col gap-[70px] xl:gap-[100px] pb-[70px] xl:pb-[100px] mt-20">
      <div class="relative w-full h-full">
        <div class="flex-equal-height container">
          ...
          <div data-aos="fade-left" class="image-section">
            <img src="assets/service1-264b6f59.png" alt />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex-equal-height gap-10 items-center container xl:gap-[100px] py-[70px] xl:py-[100px]">
      ...
      <div data-aos="fade-left" class="text-section">
        <div class="max-w-[680px] mx-auto lg:text-start text-center pt-1 xl:pt-0" data-aos="fade-right">
          <div class="flex flex-col gap-[15px] xl:gap-10">
            <div class="flex flex-col gap-[15px] xl:gap-[30px]">
              <div class="flex flex-col gap-[15px] xl:gap-[30px]">
