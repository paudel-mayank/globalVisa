    ...
    <header class="overflow-x-hidden">
         ...
         right-0 fixed top-0 bg-transparent-2 z-20 ">
            <div class="flex py-[10px] lg:py-0 justify-between container items-center">
                ...
                <div class="flex justify-end gap-[10px]">
                    ...
                    <button id="menu-toggle" class="block lg:hidden " style="z-Index:999;">
        ...
        bg-transparent-2
            ...
            <div class="relative flex flex-col items-center gap-4">
                <div class="relative w-full">
                    <div class="flex group justify-between items-center">
                        <a href="about.php"
                            ...
                            text-secondary-medium  items-start transition-all duration-300 ease-in text-[20px] leading-[26px] font-body1 w-full">
                            About Us
                        </a>
                    </div>
                </div>
                <div class="relative w-full">
                    <div class="flex group justify-between items-center">
                        <a href="service.php" class="flex  text-secondary-medium  justify-start items-start transition-all
                ...
                <div class="relative w-full">
                    <div class="flex group  justify-between items-center">
                        <a href="countries.php"
                            class="flex text-secondary-medium  justify-start items-start transition-all duration-300 ease-in text-[20px] leading-[26px] font-body1 w-full">
                            Study Abroad
                        </a>
                    </div>
                </div>
