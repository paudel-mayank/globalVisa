...
var Swiper = function() {
  ...
  function d(e, t) {
    ...
    return s.WebKitCSSMatrix
      ...
      : (n = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform
  ...
  function h(e) {
    return e.querySelector(".swiper-slide-transform")
      || e.shadowRoot && e.shadowRoot.querySelector(".swiper-slide-transform") || e;
  }
  function f(e, t) {
    void 0 === t && (t = "");
    const s = r(), a = [...e.children];
    return s.phpSlotElement && e instanceof HTMLSlotElement && a.push(...e.assignedElements()),
  ...
  var k = {
    ...
    off(e, t) {
      const s = this;
      return !s.eventsListeners || s.destroyed ? s : s.eventsListeners
        ? (e.split(" ").forEach(e => {
  ...
  const G = (e, t) => {
    ...
    Y = e => {
      ...
      } else {for (let a = Math.max(i - t, 0); a <= Math.min(r + t, s - 1); a += 1) {
          a !== i && (a > r || a < i) && X(e, a);
        }}
    };
  var B = {
    ...
    updateSlides: function() {
      ...
      const I = "auto" === s.slidesPerView && s.breakpoints
      ...
      if (
        void 0 === d && (d = function(e) {
          ...
          for (let e = 0; e < t.length; e += 1) {
            void 0 !== t[e + 1]
              ? a >= t[e] && a < t[e + 1] - (t[e + 1] - t[e]) / 2 ? i = e : a >= t[e] && a < t[e + 1] && (i = e + 1)
              : a >= t[e] && (i = e);
          }
    ...
    updateClickedSlide: function(e, t) {
      ...
      s.clickedSlide = i,
        s.virtual && s.params.virtual.enabled
          ...
          : s.clickedIndex = r,
        a.slideToClickedSlide && void 0 !== s.clickedIndex && s.clickedIndex !== s.activeIndex
  ...
  var R = {
    slideTo: function(e, t, s, a, i) {
      ...
      if (r.initialized && n !== p) {
        if (
          !r.allowSlideNext && (u ? w > r.translate && w > r.minTranslate() : w < r.translate && w < r.minTranslate())
        ) return !1;
    ...
    slidePrev: function(e, t, s) {
      ...
      if (
        ...
        && (g = n.indexOf(f),
          ...
          && (g = g - a.slidesPerViewDynamic("previous", !0) + 1, g = Math.max(g, 0))), i.rewind && a.isBeginning
      ) {
  ...
  var _ = {
    loopCreate: function(e, t) {
      ...
      if (o) {
        if (a.loopAddBlankSlides) c(l - s.slides.length % l), s.recalcSlides(), s.updateSlides();
        else {g(
            "Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)",
          );}
        r();
      } else if (d) {
        if (a.loopAddBlankSlides) c(a.grid.rows - s.slides.length % a.grid.rows), s.recalcSlides(), s.updateSlides();
        else {g(
    ...
    loopFix: function(e) {
      ...
      if (
        d.__preventObserver__ = !0,
          ...
          "auto" === h.slidesPerView
            ? d.updateSlides()
            : E && (x.length > 0 && L || S.length > 0 && P) && d.slides.forEach((e, t) => {
      ...
      if (d.allowSlidePrev = p, d.allowSlideNext = u, d.controller && d.controller.control && !l) {
        ...
        Array.isArray(d.controller.control)
          ...
          : d.controller.control instanceof d.constructor && d.controller.control.params.loop
  ...
  function F(e) {
    ...
    let p = i.target;
    if (
      "wrapper" === l.touchEventsTarget && !function(e, t) {
        const s = r();
        let a = t.contains(e);
        !a && s.phpSlotElement && t instanceof HTMLSlotElement
    ...
    p.matches(n.focusableElements) && (w = !1, "SELECT" === p.nodeName && (n.isTouched = !1)),
      s.activeElement && s.activeElement.matches(n.focusableElements) && s.activeElement !== p
  ...
  function V(e) {
    ...
    if (r.touchReleaseOnEdges && !r.loop) {
      if (s.isVertical()) {
        if (
          m < n.startY && s.translate <= s.maxTranslate() || m > n.startY && s.translate >= s.minTranslate()
        ) return i.isTouched = !1, void (i.isMoved = !1);
      } else {
        if (
          l && (u > n.startX && -s.translate <= s.maxTranslate() || u < n.startX && -s.translate >= s.minTranslate())
        ) return;
        if (
          !l && (u < n.startX && s.translate <= s.maxTranslate() || u > n.startX && s.translate >= s.minTranslate())
        ) return;
    ...
    if (
      t.activeElement && t.activeElement.matches(i.focusableElements) && t.activeElement !== p.target
      && "mouse" !== p.pointerType && t.activeElement.blur(),
    ...
    if (
      (new Date()).getTime(),
        !1 !== r._loopSwapReset && i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b && y
        && Math.abs(g) >= 1
    ) {
      return Object.assign(n, { startX: u, startY: m, currentX: u, currentY: m, startTranslate: i.currentTranslate }),
        i.loopSwapReset = !0,
    ...
    if (
      r.touchReleaseOnEdges && (x = 0),
        g > 0
          ? (b && y && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides
  ...
  function W(e) {
    ...
    r.grabCursor && s.isMoved && s.isTouched && (!0 === t.allowSlideNext || !0 === t.allowSlidePrev)
      && t.setGrabCursor(!1);
  ...
  const J = (e, t) => {
    const s = a(),
      ...
      c = t;
    r && "string" != typeof r && (s[d]("touchstart", e.onDocumentTouchStart, { passive: !1, capture: o }),
      ...
      transition: {
        setTransition: function(e, t) {
          ...
          || (s.wrapperEl.style.transitionDuration = `${e}ms`,
            s.wrapperEl.style.transitionDelay = 0 === e ? "0ms" : ""), s.emit("setTransition", e, t);
        },
  ...
  class re {
    ...
    getSlideClasses(e) {
      ...
      return t.destroyed
        ? ""
        : e.className.split(" ").filter(e => 0 === e.indexOf("swiper-slide") || 0 === e.indexOf(t.params.slideClass))
          .join(" ");
    }
    emitSlidesClasses() {
      const e = this;
  ...
  const ve = [function(e) {
    ...
    r("beforeInit", () => {
      ...
      Object.assign(s.virtual, {
        ...
        removeSlide: function(e) {
          ...
          } else {s.params.virtual.cache && (delete s.virtual.cache[e],
              Object.keys(s.virtual.cache).forEach(t => {
                t > e
                  && (s.virtual.cache[t - 1] = s.virtual.cache[t],
                    s.virtual.cache[t - 1].setAttribute("data-swiper-slide-index", t - 1),
        ...
        if (
          u.push(s),
            ...
            function(e) {
              ...
              if (e.direction < 0) { if (t.isEnd && !t.params.loop && s.releaseOnEdges) return !0; }
      ...
      return e && "string" == typeof e && t.isElement && (s = t.el.querySelector(e) || t.hostEl.querySelector(e), s)
        ...
        : (e
          && ("string" == typeof e && (s = [...document.querySelectorAll(e)]),
            t.params.uniqueNavElements && "string" == typeof e && s && s.length > 1
    ...
    function p() {
      ...
      if (
        ...
        let o, p, u;
        if (
          s.dynamicBullets && (n = S(i[0], t.isHorizontal() ? "width" : "height", !0),
            c.forEach(e => {
      ...
      c.forEach((e, r) => {
        if (
          "fraction" === s.type && (e.querySelectorAll(le(s.currentClass)).forEach(e => {
    ...
    function m() {
      ...
      "string" == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
        ...
        s || (s = e.el),
        s && 0 !== s.length
        && (t.params.uniqueNavElements && "string" == typeof e.el && Array.isArray(s) && s.length > 1
    ...
    a("changeDirection", () => {
      ...
      a("click", (e, s) => {
        ...
        if (
          t.params.pagination.el && t.params.pagination.hideOnClick && r && r.length > 0
    ...
    function b() {
      ...
      s.style.width = "",
        ...
        t.params.watchOverflow && t.enabled
    ...
    function P() {
      ...
      t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length
    ...
    function k() {
      const e = t.zoom;
      v.slideEl && t.activeIndex !== t.slides.indexOf(v.slideEl)
    ...
    function D(e) {
      ...
      s.scale = A || $,
        l = A || $,
        !e || 1 === l && A ? (u = 0, m = 0) : (L = v.slideEl.offsetWidth,
    ...
    function w(e) {
      ...
      if (
        !t.pagination || !t.pagination.el || a !== t.pagination.el && !t.pagination.el.contains(e.target)
    ...
    let i = !1, n = {};
    const l = e =>
        e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(
          /-+$/,
          "",
        ),
      o = e => {
    ...
    n("init", () => {
      ...
      n("sliderFirstMove", () => {
        !i.destroyed && i.autoplay.running
          && (i.params.autoplay.disableOnInteraction ? T() : (p = !0,
            u = !1,
            f = !1,
            m = setTimeout(() => {
              f = !0, u = !0, M(!0);
    ...
    function d(e) {
      ...
      if (t.realIndex !== s.realIndex || l) {
        ...
        l && (r += "next" === o ? n : -1 * n),
          s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(r) < 0
    ...
    me({
      ...
      setTranslate: () => {
        ...
        s.style.transform = `translate3d(0px,0,${g}px) rotateX(${c(t.isHorizontal() ? 0 : f)}deg) rotateY(${
          c(t.isHorizontal() ? -f : 0)
        }deg)`, s.style.setProperty("--swiper-cube-translate-z", `${g}px`);
      },
      setTransition: e => {
