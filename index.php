...
<div class="swiper w-full h-full mt-[50px] sm:mt-[61px] xl:mt-[79px] homeSlider">
                ...
                <div data-aos="fade-right" data-aos-duration="700"
                    ...
                    <div class="flex flex-col gap-5 sm:gap-[30px]">
                        ...
                        <p class="text-center lg:text-left text-body1 font-body1 text-textColor-light">
                            ...
                            euismod semper fringilla tristique
                            viverra
                            urna metus. Egestas
                            eleifend ultrices lacus fringilla
                            vivamus
                            nisl diam auctor.
                        </p>
                    </div>
    ...
    <div
        class="container swiper-pagination lg:flex lg:flex-col lg:gap-[10px] lg:items-end lg:!right-0 lg:!absolute lg:!top-[40%] lg:!left-auto lg:!max-w-[500px]">
    </div>
</div>
                        ...
                        <div class="flex flex-col gap-[15px] xl:gap-[30px]">
                            ...
                            <div class="flex flex-col gap-[15px] xl:gap-5">
                                <p class="text-textColor-dark">
                                    Lectus velit enim fermentum
                                    sit
                                    sed
                                    augue dolor. Egestas in
                                    dictumst sapien non id et
                                    imperdiet
                                    volutpat ullamcorper. Eu
                                    tristique mattis vitae sem
                                    facilisis. Quis at ut
                                    vestibulum
                                    vestibulum neque. Proin
                                    rhoncus
                                    felis faucibus quam non sed.
                                    Semper suspendisse sodales
                                    urna
                                    quam
                                    purus sodales.
                                </p>
                                <p class="text-textColor-dark">
                                    Tempus vulputate elementum
                                    nulla
                                    mauris hac adipiscing sit.
                                    Posuere consectetur at urna
                                    scelerisque lorem sapien ut
                                    diam
                                    semper. Enim nisl massa
                                    purus
                                    purus
                                    orci.
                                </p>
            ...
            <div class="flex flex-col gap-[15px] xl:gap-5">
                ...
                <div class="flex flex-col gap-[9px]">
                    <h2 class="text-primary-dark text-center">
                        Your Trusted
                        <!-- <span class="text-primary-light">Trusted</span> -->
                        Partner for
                        Smooth
                        <!-- <span class="text-primary-light">Smooth</span> -->
                        Visa Processing.
                    </h2>
                ...
                <div data-aos="fade-left" data-aos-duration="700" class="flex flex-col gap-5 xl:gap-10 pt-1">
                    ...
                    <div class="flex flex-col gap-[15px] xl:gap-10">
                        ...
                        <div class="flex justify-start items-start gap-[15px] xl:gap-5">
                            ...
                            <div class="flex flex-col gap-[5px] xl:gap-[10px]">
                                <div class="flex flex-col gap-[5px]">
                                    <h5 class="text-primary-dark">Fast
                                        &
                                        Simple Process</h5>
                                    <img class="max-w-full" src="assets/lineA-831eca49.svg" alt="lineA.svg" />
                                </div>
        ...
        <div class="container flex flex-col py-[70px] gap-10 sm:gap-[50px] xl:gap-[70px]">
            <div
                ...
                <div data-aos="fade-left" data-aos-duration="700"
                    ...
                    <p class="text-body1 text-center lg:text-left lg:max-w-[430px] xl:max-w-[480px]">
                        Lorem ipsum dolor sit amet consectetur.
                    ...
                    <div
                        ...
                        <i
                            class="prev-btn text-[25px] leading-[7px] px-[7px] py-[16px] cursor-pointer rounded-[20px] hover:bg-primary-light transition-all duration-300 ease-in ri-arrow-left-s-line"></i>

                        <i
                            class="next-btn text-[25px] leading-[7px] px-[7px] py-[16px] cursor-pointer rounded-[20px] bg-primary-light ri-arrow-right-s-line"></i>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper-wrapper">
                    <div
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 gap-[10px]">
                                <h4 class="text-primary-dark text-center font-semibold">India</h4>
                                <img class="max-w-full" src="assets/lineB-28c55641.svg" alt="lineB.svg" />
                                <p class="text-textColor-dark text-center">
                                    Lorem ipsum dolor sit amet
                                    consectetur. Vitae posuere
                                    velit
                                    tincidunt.
                                </p>
                            </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 gap-[10px]">
                                <h4 class="text-primary-dark text-center font-semibold">Dubai</h4>
                                <img class="max-w-full" src="assets/lineB-28c55641.svg" alt="lineB.svg" />
                                <p class="text-textColor-dark text-center">
                                    Lorem ipsum dolor sit amet
                                    consectetur. Vitae posuere
                ...
                <div class="flex flex-col gap-[15px] xl:gap-[30px]">
                    <div class="flex flex-col gap-[15px] xl:gap-5">
                        ...
                        <div class="flex flex-col gap-[9px]">
                            <h2 class="text-primary-dark">
                                Have any
                                <span class="text-primary-light">Inquiries?</span>
                                Contact us
                                <span class="text-primary-light">Anytime!</span>
                            </h2>
                            <img class="max-w-full" src="assets/lineA-831eca49.svg" alt="lineA.svg" />
                        </div>
                    </div>
